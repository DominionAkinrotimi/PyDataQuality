...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 2: Great Expectations Configuration vs Computation Workflow}]{fig_great_expectations_bw.png}}
\caption{Figure 2: Great Expectations Configuration vs Computation
Workflow}
\end{figure}

\textbf{Figure 2:} Illustration of the Great Expectations workflow.
While computationally robust, the operational burden is heavily skewed
toward configuration, requiring developers to orchestrate multiple
interconnected YAML and JSON artifacts (Data Contexts, Expectation
Suites, and Checkpoints) before data validation can execute.
