...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image1.png}}
...
stable; 0.1--0.25: moderate; $\geq$ 0.25: significant) provide immediately
...
\bottomrule\noalign{}
\endlastfoot
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image2.png}} \\
\end{longtable}
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image4.jpeg}}
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image5.jpeg}}
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image6.jpeg}}
...
of
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image7.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image8.png}}
with
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image9.png}}
distinct categories
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image10.png}},
and the empirical probability of each category:

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image11.png}}

The \textbf{Shannon Entropy}
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image12.png}}
is defined as:

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image13.png}}

Where entropy is measured in bits. The maximum possible entropy for
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image9.png}}
classes is
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image14.png}}
bits (achieved when all classes are equally probable, i.e.,
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image15.png}}
for all
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image16.png}}),
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image17.png}}

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image18.png}}

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image19.png}}

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image20.png}}

\emph{Our system output:} \texttt{1.485475~bits}

\emph{Experiment 2: Near-uniform distribution (33/33/34 split)}

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image21.png}}

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image22.png}}

\emph{Our system output:} \texttt{1.584819~bits}

(Note: 1.5848 ≈
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image23.png}},
confirming near-maximum entropy)

\emph{Experiment 3: Binary balance (50/50 split)}

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image24.png}}

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image25.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image26.png}}
(after removing missing values):

\textbf{Step 1: Compute Quartiles:}

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image27.png}}

\textbf{Step 2: Compute Interquartile Range:}

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image28.png}}

\textbf{Step 3: Establish Validation Fences} (using configurable
multiplier
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image16.png}},
default
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image29.png}}):

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image30.png}}

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image31.png}}

\textbf{Step 4: Flag Outliers:} Any sample
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image32.png}}
satisfying:

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image33.png}}
...
\begin{itemize}
\item
  \texttt{severity="warning"} if the outlier percentage is <
  10\% of the total non-null sample
\item
  \texttt{severity="critical"} if the outlier percentage is $\geq$ 10\% of
...
\item
  \pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image34.png}}:
...
Dataset:
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image35.png}}

Step 1:
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image36.png}},
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image37.png}}

(from \texttt{data.quantile(0.25)} and \texttt{data.quantile(0.75)})

Step 2:
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image38.png}}

Step 3 (k=1.5):

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image39.png}}

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image40.png}}

Step 4: Values
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image41.png}}
and
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image42.png}},
therefore:
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image43.jpeg}}
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image16.png}}=1.5.

\textbf{Why IQR Over Z-Score?} The IQR method is preferred over the
standard Z-score method
(\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image44.png}})
because:
...
Let
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image45.png}}
and
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image46.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image47.png}}
bins via decile percentiles
(\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image48.png}}
by default):

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image49.png}}

The expected proportion in bin
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image50.png}}
(from the reference distribution) and actual proportion in bin
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image50.png}}
(from the current distribution) are:

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image51.png}}

where
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image52.png}}
is a regularization constant to prevent division-by-zero or
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image53.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image54.png}}
in the union of both category sets:

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image55.png}}

\textbf{PSI Formula} (summed over all bins
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image47.png}}):

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image56.png}}
...
\bottomrule\noalign{}
\endlastfoot
PSI < 0.10 & Stable & Proceed with normal processing \\
0.10 < PSI < 0.25 & Moderate Drift & Issue warning; flag for human review \\
PSI $\geq$ 0.25 & Significant Drift & Halt inference; trigger model
retraining \\
\end{longtable}
}
...
population
(\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image58.png}},
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image59.png}},
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image60.png}}):
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image61.png}}
and
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image62.png}},
their \textbf{Empirical Cumulative Distribution Functions (ECDFs)} are:

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image63.png}}

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image64.png}}

where
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image65.png}}
is the indicator function, equal to 1 if
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image66.png}}
and 0 otherwise. In other words,
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image67.png}}
is the fraction of observations in the sample that are ≤
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image68.png}}.
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image69.png}}
...
distribution of
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image70.png}}
converges to the Kolmogorov distribution. The p-value is approximated
via:

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image71.png}}

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image72.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image73.png}}):

\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image74.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image75.jpeg}}
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image76.png}}
and
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image77.png}}
...
``highly significant''
(\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image78.png}})
...
<< 0.05) provides strong evidence for real drift,
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image79.png}}
...
df.loc{[}df{[}\textquotesingle salary\textquotesingle{]} <
...
\caption{\includegraphics[keepaspectratio]{latex_media/media/image80.png}}\tabularnewline
\toprule\noalign{}
\endfirsthead
\endhead
\bottomrule\noalign{}
...
\emph{approved = (np.random.rand(rows) < 
...
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image81.png}}
...
(Regression,
\pandocbounded{\includegraphics[keepaspectratio]{latex_media/media/image82.png}}).
...
distribution shifts (PSI > 3.0), raises an engineering
...
3.5517 and KS p-value < 10⁻³²¹ providing unambiguous evidence
...
\subsection{VIII. Availability}\label{viii.-availability}

\textbf{Requirements:} Python $\geq$ 3.8, pandas $\geq$ 1.3, numpy $\geq$ 1.21,
matplotlib $\geq$ 3.4, Jinja2 $\geq$ 3.0. Optional: scipy (for exact KS test),
